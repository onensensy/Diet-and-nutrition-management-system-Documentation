...
\begin{tabular}[c]{@{}l@{}} To test and Validate \\the System\end{tabular} & \begin{tabular}[c]{@{}l@{}} System testing and Validation \end{tabular} & \begin{tabular}[c]{@{}l@{}} Software testing tools \\such as programming \\language testing \\libraries, visual Basic  \end{tabular} & \begin{tabular}[c]{@{}l@{}} Fully Developed \\System \end{tabular}\\ \hline
\begin{tabular}[c]{@{}l@{}} To test and Validate \\the System\end{tabular} & \begin{tabular}[c]{@{}l@{}} System testing and Validation \end{tabular} & \begin{tabular}[c]{@{}l@{}} Software testing tools \\such as programming \\language testing \\libraries, visual Basic  \end{tabular} & \begin{tabular}[c]{@{}l@{}} Fully Developed \\System \end{tabular} \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{tabular}{|l|l|l|}
\hline
\multicolumn{3}{|c|}{\textbf{Project part 1 completed}} \\
\hline
\textbf{Activity} & \textbf{Duration} & \textbf{Deliverables} \\ \hline
Concept paper & 2 weeks & Problem statement and objectives \\ \hline
Literature review & 2 weeks & Overview of previously developed systems relating to the topic \\ \hline
Methodology & 2 weeks & Summary of how the project objectives will be achieved \\ \hline
Proposal & 1 week & Summary of concept paper, literature review, and methodology \\ \hline
\hline
\multicolumn{3}{|c|}{\textbf{Project part 2}} \\
\hline
\textbf{Activity} & \textbf{Duration} & \textbf{Deliverables} \\ \hline
Data collection and deriving of system requirements & 3 weeks & System requirements document \\ \hline
Implementation, testing and validation of the system & 8 weeks & Fully developed system \\ \hline
Conclusions and future work & 3 weeks & Final report \\ \hline
Developing slides for the developed system & 1 week & Presentation \\ \hline
\end{tabular}
...
\newpage
\section{Appendix C: \newline A guide to data collection using questionnaires and interviews}
