...
\begin{tabular}[c]{@{}l@{}} Accessibility/\\Affordable(Free) \end{tabular} &  & &  &  &  &  & \textbf{YES}\\ \bottomrule
\end{tabular}%
}
\end{table}
...
\begin{center}
\vspace{30px}
\includegraphics[width=300px]{Images/Proposal_waterfall-SDLC.png}
...
\begin{table}[H]
\centering
\caption{Tabular Representation of Methodologies}
\label{tab:tabular-representaion-of-methodologies}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{@{}|l|l|l|l|l|l|l|l|@{}}
\toprule
\multicolumn{1}{|c|}{\textbf{Objective}} & \textbf{Stage} & \textbf{Tool(s)} & \textbf{Output} \\ \midrule
\begin{tabular}[c]{@{}l@{}} To identify \\requirements for \\the Diet \\Management system \end{tabular} & System Planning & Online Google Form & \begin{tabular}[c]{@{}l@{}} System Requirements \\Document \end{tabular} \\  \midrule
\begin{tabular}[c]{@{}l@{}} To design a model \\for the system \end{tabular} & System Design  & \begin{tabular}[c]{@{}l@{}} Draw.io/Diagram.net ******\end{tabular} & \begin{tabular}[c]{@{}l@{}} System Design \\Document\end{tabular} \\ \midrule
\begin{tabular}[c]{@{}l@{}} To implement the System\end{tabular} & \begin{tabular}[c]{@{}l@{}} System Implementation \end{tabular} & \begin{tabular}[c]{@{}l@{}} MySQL, HTML, \\JavaScript, CSS, PHP\end{tabular} & \begin{tabular}[c]{@{}l@{}} System for \\Testing\end{tabular} \\ \midrule
\begin{tabular}[c]{@{}l@{}} To test and Validate \\the System\end{tabular} & \begin{tabular}[c]{@{}l@{}} System testing and Validation \end{tabular} & \begin{tabular}[c]{@{}l@{}} Software testing tools \\such as programming \\language testing \\libraries, visual Basic  \end{tabular} & \begin{tabular}[c]{@{}l@{}} Fully Developed \\System \end{tabular} \\ \bottomrule
\end{tabular}%
}
\end{table}
