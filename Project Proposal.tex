...
\begin{tabular}[c]{@{}l@{}} To test and Validate \\the System\end{tabular} & \begin{tabular}[c]{@{}l@{}} System testing and Validation \end{tabular} & \begin{tabular}[c]{@{}l@{}} Software testing \\tools such as \\programming \\language testing \\libraries, visual Basic  \end{tabular} & \begin{tabular}[c]{@{}l@{}} Fully Developed \\System \end{tabular} \\ \bottomrule
\end{tabular}%
}
\end{table}
